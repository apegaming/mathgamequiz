...
namespace ApeGaming.MathGame
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1wDNdbpVSGvUgLohERlR2JLQjOkgTnY2xceEaz5DLHsE/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/mAb";

		private const string NAME_OF_THE_GAME = "MATH GAME";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		...
		private const string FACEBOOK_URL = "https://facebook.com/ApeGaming";
		private const string REQUEST_URL = "https://ApeGaming.zendesk.com/hc/en-us/requests/new";
		private const string ApeGaming_UNITY_CATALOG_URL = "http://bit.ly/2ee6aed";//"http://u3d.as/9cs";
		private const string COMMUNITY_URL = "https://ApeGaming.zendesk.com/hc/en-us/community/topics";
		...
		public const string PREFSHOWATSTARTUP = "ApeGaming" + NAME_OF_THE_GAME + ".PREFSHOWATSTARTUP";
		...
		[MenuItem("Tools/APE GAMING/"+NAME_OF_THE_GAME+"/Welcome Screen", false, 0)]
		[MenuItem("Window/APE GAMING/" + NAME_OF_THE_GAME+"/Welcome Screen", false, 0)]
		...
		public void OnGUI(){
			...
			if (Button(moreGamesIcon,"More Unity assets from us","Have a look to our Unity's Asset Store catalog!")){
				Application.OpenURL(ApeGaming_UNITY_CATALOG_URL);
			}
		...
		void InitInterface(){
			...
			if (!interfaceInitialized){
				...
				imgHeader.normal.background = (Texture2D)Resources.Load("ApeGamingBanner");
