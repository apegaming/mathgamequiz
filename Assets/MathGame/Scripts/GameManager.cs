...
namespace ApeGaming.MathGame
{
    public class GameManager : MonoBehaviour
    {
        ...
        void PlayMusic()
        {
            SoundManager.soundInstance.PlayMusic("backgourndMusic");
        }
        ...
        // <summary>
        /// If using Very Simple Leaderboard by APE GAMING, report the score
        /// </summary>
        ...
        /// <summary>
        /// If using Very Simple Ads by APE GAMING, show an interstitial if number of play > numberOfPlayToShowInterstitial
        /// </summary>
        public void ShowAds()
        {
            ...
            PlayerPrefs.Save();
            Debug.Log("ShowAds" + count + "   " + numberOfPlayToShowInterstitial);
            if (count == 1)
            {
#if UNITY_EDITOR
                Debug.Log("count = " + count + " > numberOfPlayToShowINterstitial = " + numberOfPlayToShowInterstitial);
#endif
                //if (AdManager.instance.RequestInterstitial())
                //{
#if UNITY_EDITOR
                Debug.Log("AdsManager.instance.IsReadyInterstitial() == true ----> SO ====> set count = 0 AND show interstial");
#endif
                PlayerPrefs.SetInt("GAMEOVER_COUNT", 0);
