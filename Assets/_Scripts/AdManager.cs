...
public class AdManager : MonoBehaviour
{
    ...
    public string adIdInterstitial;
    public string adIdRewardedVideo;
    ...
    public void RequestInterstitial()
    {
        ...
        string adUnitId = adIdInterstitial;
    ...
    {
        string adUnitId = adIdRewardedVideo;
